 ...
 * -index : 对应的下标
 */
- (HotChildViewController<ZJScrollPageViewChildVcDelegate> *)childViewController:(HotChildViewController<ZJScrollPageViewChildVcDelegate> *)reuseViewController forIndex:(NSInteger)index;
