...
typedef void(^BtnBackClick)(void);
typedef void(^BtnMoreClick)(void);
...
@property (nonatomic, copy) BtnBackClick btnBackBlock;
@property (nonatomic, copy) BtnMoreClick btnMoreClick;
