...
/*
 ...
 RadarMapCompleteView *radar = [[RadarMapCompleteView alloc]initWithRadarElements:@[@"考试次数",@"考试难度",@"联系次数",@"平均得分",@"错误率",@"准确率"] lengthColor:[UIColor grayColor]];
...
@interface RadarMapCompleteView : UIView
 ...
 *  更新选项标题
 *
 *  @param elements 标题数组<ElementItem>
 */
