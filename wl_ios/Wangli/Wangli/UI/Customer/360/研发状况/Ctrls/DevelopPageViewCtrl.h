...
@interface DevelopPageViewCtrl : GKBaseViewController <GKPageScrollViewDelegate>
...
//            [self.segmentView setupTitle:currentListVC.segTitle count:currentListVC.totalElements];
//        });
//    }];
//}
//
