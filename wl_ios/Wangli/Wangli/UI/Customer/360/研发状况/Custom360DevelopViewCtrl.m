...
#import "Custom360DevelopViewCtrl.h"
#import "SwitchView.h"
#import "FilterListView.h"
#import "EmptyView.h"
#import "DevelopPageViewCtrl.h"

@interface Custom360DevelopViewCtrl () <SwitchViewDelegate, FilterListViewDelegate>
...
@property (nonatomic, strong) DevelopPageViewCtrl *pageViewCtrl;
...
@implementation Custom360DevelopViewCtrl
...
- (SwitchView *)switchView {
    if (!_switchView) {
        _switchView = [[SwitchView alloc] initWithTitles:@[@"业务类型", @"研发情报"]
...
- (DevelopPageViewCtrl *)pageViewCtrl {
    if (!_pageViewCtrl) {
        _pageViewCtrl = [[DevelopPageViewCtrl alloc] init];
    }
...
- (DicMo *)rightDic {
    if (!_rightDic) {
        ...
        _rightDic.value = @"所有";
        _rightDic.key = @"all";
        _rightDic.remark = @"research_development_type";
    }
    return _rightDic;
}
...
- (DicMo *)rightDicDefault {
    if (!_rightDicDefault) {
        ...
        _rightDicDefault.remark = @"research_development_type";
    }
