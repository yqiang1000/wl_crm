//
//  ContractPageReconciliationViewCtrl.m
//  Wangli
//
...
@interface ContractPageReconciliationViewCtrl () <SwitchViewDelegate, FilterListViewDelegate>
...
@implementation ContractPageReconciliationViewCtrl
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *identifier = @"ContractReconciliationCell";
    ContractReconciliationCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        cell = [[ContractReconciliationCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
    [cell loadDataWith:@""];
    return cell;
}
