...
@interface ContractContractCell ()

@property (nonatomic, strong) UIView *baseView;
@property (nonatomic, strong) UIView *lineView;
@end

@implementation ContractContractCell
...
//        _model = model;
//    }
    self.labTitle.text = @"单面 PERC 21.2% |   HT20181101001";
    self.labYear.text = @"2018";
    self.labMonth.text = @"11";
    self.labTotalSend.text = @"87010";
    self.labRealSend.text = @"27,010";
    self.progressView.progress = arc4random() % 100 / 100;
    [((UILabel *)self.progressView.centralView) setText:[NSString stringWithFormat:@"%2.0f%%", self.progressView.progress * 100]];
