...
@interface ContractOrderCell ()

@property (nonatomic, strong) UIView *baseView;
@property (nonatomic, strong) UIView *lineView;
@end

@implementation ContractOrderCell
...
- (void)setUI {
    ...
    [self.labRealNote mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.baseView).offset(IS_IPHONE5?220:250);
    }];
...
- (void)loadDataWith:(NSString *)model {
    ...
    //        _model = model;
    //    }
    self.labTitle.text = @"NO.10029181 | ZOR2 | 1100";
    self.labYear.text = @"2018";
    self.labMonth.text = @"11";
    self.labTotalSend.text = @"单面 PERC 21.2%";
    self.labRealSend.text = @"27,010";
    self.labTotalNote.text = @"100289-晶科";
