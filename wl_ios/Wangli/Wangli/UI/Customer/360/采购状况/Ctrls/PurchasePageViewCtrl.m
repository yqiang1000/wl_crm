...
#import "PurchasePageViewCtrl.h"
#import "PurchasePageSupplierViewCtrl.h"
#import "PurchasePageCatalogViewCtrl.h"
#import "PurchasePageAccessViewCtrl.h"
#import "PurchasePageEvaluationViewCtrl.h"
#import "PurchaseCollectionView.h"
#import "PurchaseListTitleView.h"
#import "PurchaseCommonCreateViewCtrl.h"

@interface PurchasePageViewCtrl () <UIScrollViewDelegate, PurchaseCollectionViewDelegate>
...
@implementation PurchasePageViewCtrl
...
- (void)selfRefresh {
    NSLog(@"获取九宫格数据");
    [[JYUserApi sharedInstance] getPurchaseSummaryNumberByMemberId:TheCustomer.customerMo.id key:self.currentDic.key param:nil success:^(id responseObject) {
        NSError *error = nil;
...
- (void)itemAddClick:(UIButton *)sender {
    NSArray *dynamicIds = @[K_PURCHASE_SUPPLIER,
                            K_PURCHASE_PRODUCT,
                            K_PURCHASE_ACCESS,
                            K_PURCHASE_EVALUATION];
...
- (NSArray *)childVCs {
    if (!_childVCs) {
        PurchasePageSupplierViewCtrl *page0 = [PurchasePageSupplierViewCtrl new];
        PurchasePageCatalogViewCtrl *page1 = [PurchasePageCatalogViewCtrl new];
        PurchasePageAccessViewCtrl *page2 = [PurchasePageAccessViewCtrl new];
        PurchasePageEvaluationViewCtrl *page3 = [PurchasePageEvaluationViewCtrl new];
