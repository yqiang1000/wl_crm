...
#import "Custom360PurchaseViewCtrl.h"
#import "SwitchView.h"
...
@interface Custom360PurchaseViewCtrl () <SwitchViewDelegate, FilterListViewDelegate>
...
@property (nonatomic, strong) PurchasePageViewCtrl *pageViewCtrl;
...
@implementation Custom360PurchaseViewCtrl
...
- (SwitchView *)switchView {
    if (!_switchView) {
        _switchView = [[SwitchView alloc] initWithTitles:@[@"业务类型", @"采购情报"]
...
- (PurchasePageViewCtrl *)pageViewCtrl {
    if (!_pageViewCtrl) {
        _pageViewCtrl = [[PurchasePageViewCtrl alloc] init];
...
- (DicMo *)rightDic {
    if (!_rightDic) {
        ...
        _rightDic.value = @"所有";
        _rightDic.key = @"all";
        _rightDic.remark = @"purchare_type";
    }
    return _rightDic;
}
...
- (DicMo *)rightDicDefault {
    if (!_rightDicDefault) {
        ...
        _rightDicDefault.remark = @"purchare_type";
    }
