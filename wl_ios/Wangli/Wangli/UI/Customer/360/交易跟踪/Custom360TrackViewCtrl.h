...
@interface Custom360TrackViewCtrl : SubjectViewCtrl
...
//    if (!_filterView) {
//        _filterView = [[RiskTopView alloc] initWithItems:@[@"交易跟踪", @"信息总览"] imgSelect:@[@"drop_down_s", @""] imgNormal:@[@"client_down_n", @""] colorSelect:COLOR_C1 colorNormal:COLOR_B2];
