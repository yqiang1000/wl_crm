...
@implementation LinkManOfficeCell
...
- (void)btnIconClick:(UIButton *)sender {
    if (_linkDelegate && [_linkDelegate respondsToSelector:@selector(linkManOfficeCell:didSelected:indexPath:)]) {
        [_linkDelegate linkManOfficeCell:self didSelected:self.btnIcon.selected indexPath:self.indexPath];
    }
}
