...
#import "Custom360SalesViewCtrl.h"
#import "SwitchView.h"
#import "FilterListView.h"
#import "EmptyView.h"
#import "SalesPageViewCtrl.h"

@interface Custom360SalesViewCtrl () <SwitchViewDelegate, FilterListViewDelegate>
...
@property (nonatomic, strong) SalesPageViewCtrl *pageViewCtrl;
...
@implementation Custom360SalesViewCtrl
...
- (SwitchView *)switchView {
    if (!_switchView) {
        _switchView = [[SwitchView alloc] initWithTitles:@[@"业务类型", @"销售情报"]
...
- (SalesPageViewCtrl *)pageViewCtrl {
    if (!_pageViewCtrl) {
        _pageViewCtrl = [[SalesPageViewCtrl alloc] init];
    }
...
- (DicMo *)rightDicDefault {
    if (!_rightDicDefault) {
        ...
        _rightDicDefault.remark = @"sales_type";
    }
