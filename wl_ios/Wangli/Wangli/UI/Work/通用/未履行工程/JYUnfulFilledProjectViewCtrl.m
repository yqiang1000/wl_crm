//
//  JYUnfulFilledProjectViewCtrl.m
//  Wangli
//
...
@interface JYUnfulFilledProjectViewCtrl ()

@end

@implementation JYUnfulFilledProjectViewCtrl
...
- (JYUnfulfilledProjectMo *)itemMo {
    if (!_itemMo) _itemMo = [[JYUnfulfilledProjectMo alloc] init];
    return _itemMo;
}
