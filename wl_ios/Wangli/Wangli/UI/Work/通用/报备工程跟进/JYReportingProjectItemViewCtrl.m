//
//  JYReportingProjectItemViewCtrl.m
//  Wangli
//
...
@interface JYReportingProjectItemViewCtrl ()

@end

@implementation JYReportingProjectItemViewCtrl
...
- (JYReportingProjectMo *)itemMo {
    if (!_itemMo) _itemMo = [[JYReportingProjectMo alloc] init];
    return _itemMo;
}
