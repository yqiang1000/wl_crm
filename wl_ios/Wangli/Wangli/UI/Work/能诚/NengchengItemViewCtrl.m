...
@interface NengchengItemViewCtrl ()
...
@implementation NengchengItemViewCtrl
...
- (NengChengItemMo *)itemMo {
    if (!_itemMo) _itemMo = [[NengChengItemMo alloc] init];
    return _itemMo;
}
