...
@interface DevelopVisitViewCtrl ()

@end

@implementation DevelopVisitViewCtrl
...
- (VisitIntentionMo *)itemMo {
    if (!_itemMo) _itemMo = [[VisitIntentionMo alloc] init];
    return _itemMo;
}
