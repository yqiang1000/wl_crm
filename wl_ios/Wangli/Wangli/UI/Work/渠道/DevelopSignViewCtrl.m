...
@interface DevelopSignViewCtrl ()

@end

@implementation DevelopSignViewCtrl
...
- (SignIntentionMo *)itemMo {
    if (!_itemMo) _itemMo = [[SignIntentionMo alloc] init];
    return _itemMo;
}
