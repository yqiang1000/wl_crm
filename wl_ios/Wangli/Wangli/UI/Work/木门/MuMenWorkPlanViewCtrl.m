...
@interface MuMenWorkPlanViewCtrl () <UITableViewDelegate, UITableViewDataSource, ListSelectViewCtrlDelegate, MyTextViewCellDelegate, DefaultInputCellDelegate, MemberSelectViewCtrlDelegate, JYUserMoSelectViewCtrlDelegate, MySwitchCellDelegate>
...
@implementation MuMenWorkPlanViewCtrl
...
- (void)dealWithParams:(NSMutableDictionary *)params attachementList:(NSArray *)attachementList {
    ...
    switch (self.workType) {
        case JYWorkTypeLvMuMen: workTypeStr = @"ALD";
            break;
        case JYWorkTypeZhiNengSuo: workTypeStr = @"HYZNG";
            break;
        case JYWorkTypeTongMuMen: workTypeStr = @"CERART";
            break;
        case JYWorkTypeMuMen: workTypeStr = @"TIMBER";
            break;
    }
    [params setObject:workTypeStr forKey:@"workPlanType"];
