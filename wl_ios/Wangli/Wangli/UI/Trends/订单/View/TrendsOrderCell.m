...
@interface TrendsOrderCell ()

@property (nonatomic, strong) UIView *baseView;
@property (nonatomic, strong) UIView *lineView;
@end

@implementation TrendsOrderCell
...
- (void)loadDataWith:(TrendsOrderMo *)model {
    ...
    self.labTitle.text = _model.memberName;
    ...
    self.labProduct.text = _model.materialDesp.length==0?@"暂无描述":_model.materialDesp;
    self.labCode.text = [NSString stringWithFormat:@"NO.%@ | %@ | %@", _model.number, _model.auart, _model.fkId];
    self.labState.text = _model.status;
