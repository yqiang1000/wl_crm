...
@interface TrendsInvoiceCell ()

@property (nonatomic, strong) UIView *baseView;
@property (nonatomic, strong) UIView *lineView;
@end

@implementation TrendsInvoiceCell
...
//    self.labTitle.text = [NSString stringWithFormat:@"%@-%@", _model.member[@"crmNumber"], _model.member[@"abbreviation"]];
    self.labTitle.text = [NSString stringWithFormat:@"%@-%@", _model.memberNumber, _model.memberName];
...
//    self.labNum.text = [NSString stringWithFormat:@"%@", _model.netwr];
}
