...
#import "TrendsMarketActiveViewCtrl.h"
#import "TrendsMarketActiveCollectioniCell.h"
#import "TrendsCreateActivityViewCtrl.h"

@interface TrendsMarketActiveViewCtrl ()

@end

static NSString *identifier = @"TrendsMarketActiveCollectioniCell";

@implementation TrendsMarketActiveViewCtrl

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"活动大全";
    self.rightBtn.hidden = NO;
    self.placeHoder = @"请输入标题或内容关键字";
...
//                                                      @"已取消"]];
    ...
    [self updateSwitchTitles:@[@"活动类型", @"重要程度", @"活动日期"]];
    [self.collectionView registerClass:[TrendsMarketActiveCollectioniCell class] forCellWithReuseIdentifier:identifier];
    [self refreshView];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    TrendsMarketActiveCollectioniCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:identifier forIndexPath:indexPath];
